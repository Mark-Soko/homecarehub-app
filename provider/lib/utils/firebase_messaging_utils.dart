...
void showNotification(int id, String title, String message, RemoteMessage remoteMessage) async {
  ...
  flutterLocalNotificationsPlugin.show(id, remoteMessage.notification!.title.validate(), parseHtmlString(remoteMessage.notification!.body.validate()), platformChannelSpecifics);
}
