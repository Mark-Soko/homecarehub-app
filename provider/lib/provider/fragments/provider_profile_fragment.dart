...
import 'package:handyman_provider_flutter/provider/resource/view/resource_list_screen.dart';
...
import 'package:handyman_provider_flutter/provider/refund/refund_requests_screen.dart';
import 'package:handyman_provider_flutter/provider/wallet/wallet_screen.dart';
                ...
                child: Column(
                  children: [
                    ...
                    SettingItemWidget(
                      ...
                      trailing: Icon(Icons.chevron_right, color: appStore.isDarkMode ? white : gray.withOpacity(0.8), size: 24),
                      onTap: () {
                        ResourceListScreen(audience: appStore.userType == USER_TYPE_HANDYMAN ? 'handyman' : 'provider').launch(context);
                      },
                    ),
                    Divider(height: 0, thickness: 1, indent: 15.0, endIndent: 15.0, color: context.dividerColor),
                    SettingItemWidget(
                    ...
                    if (appStore.earningTypeCommission)
                      Column(
                        ...
                        children: [
                          ...
                          SettingItemWidget(
                            leading: Icon(Icons.receipt_long, size: 20, color: appStore.isDarkMode ? white : gray.withOpacity(0.8)),
                            title: 'Refund Requests',
                            trailing: Icon(Icons.chevron_right, color: appStore.isDarkMode ? white : gray.withOpacity(0.8), size: 24),
                            onTap: () {
                              RefundRequestsScreen().launch(context);
                            },
                          ),
                        ],
                      ),
