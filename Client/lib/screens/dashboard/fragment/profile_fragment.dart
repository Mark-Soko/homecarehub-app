...
import 'package:booking_system_flutter/screens/resource/view/resource_list_screen.dart';
...
import 'package:booking_system_flutter/screens/refund/refund_requests_screen.dart';
                    ...
                    return SettingSection(
                      ...
                      items: [
                        ...
                        if (appStore.isLoggedIn)
                          SettingItemWidget(
                            decoration: BoxDecoration(color: context.cardColor),
                            leading: Icon(Icons.receipt_long, size: SETTING_ICON_SIZE.toDouble(), color: context.iconColor),
                        ...
                        SettingItemWidget(
                          ...
                          padding: EdgeInsets.only(top: 20, left: 16, right: 16),
                          onTap: () {
                            ResourceListScreen(audience: 'handyman').launch(context);
                          },
                        ),
