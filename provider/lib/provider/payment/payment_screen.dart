...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> _showMpesaPhoneDialogAndSave() async {
      ...
      builder: (context) {
        return AppCommonDialog(
          ...
          child: Column(
            ...
            children: [
              Text('Enter the number you will pay from via M-Pesa.', style: secondaryTextStyle()),
              16.height,
              AppTextField(
                ...
                decoration: inputDecoration(
                  context,
                  hint: 'Phone number - 07XXXXXXXX or 2547XXXXXXXX',
                ),
              ),
              20.height,
              Row(
                children: [
                  ...
                  AppButton(
                    ...
                    onTap: () async {
                      ...
                      String txnId = 'MPESA-${DateTime.now().millisecondsSinceEpoch}';

                      // For now we treat M-Pesa as offline confirmation: provider pays via M-Pesa, then we record payment.
                      savePayment(
                        data: widget.selectedPricingPlan,
                        paymentMethod: PAYMENT_METHOD_MPESA,
  ...
  void _handleClick() async {
    ...
    if (selectedPaymentSetting!.type == PAYMENT_METHOD_MPESA) {
      await _showMpesaPhoneDialogAndSave();
    } else if (selectedPaymentSetting!.type == PAYMENT_METHOD_STRIPE) {
